...
const uiHelpers=['syncBlockType','newBlockSession_','runWriteThenRefresh_','writesAllowed_','tryStartWrite_','runRecovery_','buildRecoveryNotice_','allDayPeriodText','formatDate','addDays','pad'].map(name=>functionSource(app,name)).join('\n');
